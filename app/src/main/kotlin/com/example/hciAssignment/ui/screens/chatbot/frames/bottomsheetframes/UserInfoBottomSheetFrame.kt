...
fun UserInfoBottomSheetFrame(
    ...
    Column(
        ...
        Row(
            ...
            IconButton(
                onClick = {
                    viewModel.setEvent(ChatbotContract.Event.OnBackToSeatSelectionClicked)
                }
            ) {
                Icon(
        ...
        Column(
            ...
            OutlinedTextField(
                ...
                onValueChange = { newName ->
                    viewModel.setEvent(ChatbotContract.Event.OnNameValueChange(newName))
                },
            ...
            OutlinedTextField(
                ...
                onValueChange = { newSurname ->
                    viewModel.setEvent(ChatbotContract.Event.OnSurnameValueChange(newSurname))
                },
            ...
            OutlinedTextField(
                ...
                onValueChange = { newEmail ->
                    viewModel.setEvent(ChatbotContract.Event.OnEmailValueChange(newEmail))
                },
                maxLines = 1,
            ...
            OutlinedTextField(
                ...
                onValueChange = { newPhone ->
                    viewModel.setEvent(ChatbotContract.Event.OnTelephoneValueChange(newPhone))
                },
                maxLines = 1,
            ...
            Button(
                onClick = {
                    viewModel.setEvent(ChatbotContract.Event.OnProceedToPaymentClicked)
                },
