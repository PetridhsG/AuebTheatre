...
fun CheckoutBottomSheetFrame(
    ...
    Column(
        ...
        Row(
            ...
            IconButton(
                onClick = {
                    viewModel.setEvent(ChatbotContract.Event.OnBackToUserInfoClicked)
                }
            ) {
                Icon(
            ...
            // Close Button
            IconButton(
                onClick = { viewModel.setEvent(ChatbotContract.Event.OnCancelBookingClicked) }
            ) {
                Icon(
        ...
        Column(
            ...
            OutlinedTextField(
                ...
                onValueChange = {
                    viewModel.setEvent(ChatbotContract.Event.OnCardholderNameValueChange(it))
                },
            ...
            OutlinedTextField(
                ...
                onValueChange = {
                    viewModel.setEvent(ChatbotContract.Event.OnCardNumberValueChange(it))
                },
            ...
            OutlinedTextField(
                ...
                onValueChange = {
                    viewModel.setEvent(ChatbotContract.Event.OnExpiryDateValueChange(it))
                },
            ...
            OutlinedTextField(
                ...
                onValueChange = {
                    viewModel.setEvent(ChatbotContract.Event.OnCvvValueChange(it))
                },
            ...
            Button(
                onClick = { viewModel.setEvent(ChatbotContract.Event.OnConfirmPaymentClicked) },
